...
\begin{figure}[h]
    \centering
    \subfloat[\centering ]{{\includegraphics[width=2.0cm]{../sample_code/parallel_out.png} }}%
    \subfloat[\centering ]{{\includegraphics[width=2.0cm]{../sample_code/greedy_out.png} }}%
    \subfloat[\centering ]{{\includegraphics[width=3.2cm]{../sample_code/parallel_out_son_goku_1000.png} }}%
    \subfloat[\centering ]{{\includegraphics[width=3.2cm]{../sample_code/greedy_out_son_goku_1000.png} }}%
...
\begin{itemize}
    ...
    We also note that the hardware Numa architecture might play a role here, as the total number of CPU cores it has per domain is $16$. 
...
The image is bisected at $\bar{y} = \lceil h/2 \rceil$, we execute the parallel triangular approach in parallel, on starting on the top and the other on the bottom as shown in image \ref{fig:midpoint_sync_comparison}. The final seam is reconstructed by identifying the optimal midpoint $\hat{x}$ via the formula 
\begin{equation}
...
\begin{figure}[h]
    \centering
    \subfloat[\centering Midpoint Synchronization]{{\includegraphics[width=10cm]{./images/IMG_0035.png} }}%
    \hspace{-0.4cm} 
    \subfloat[\centering Performance Results]{{\includegraphics[width=5cm]{./images/performance_last_image.png} }}%
