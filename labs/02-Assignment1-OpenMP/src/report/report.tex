...
\begin{itemize}
    ...
    \begin{equation}
        T(W, H, C) = \min\left(C, \left\lfloor \frac{W \times H}{K} \times \frac{C}{32} \right\rfloor\right) \quad K = 1024 \times 768
    \end{equation}
