...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{performance_variance_plot.png}
...
With respect to the block size, we observe the best configuration across different number of particles is always $256$ threads per block.
\end{enumerate}
